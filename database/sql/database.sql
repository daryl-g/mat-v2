...
CREATE TABLE IF NOT EXISTS mat_silver.competition (
    ...
    tournament_calendar_id uuid NOT NULL UNIQUE DEFAULT uuidv7(),
...
CREATE TABLE IF NOT EXISTS mat_silver.stage (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    competition_id uuid NOT NULL REFERENCES mat_silver.competition(id) ON DELETE CASCADE ON UPDATE CASCADE,
    tournament_calendar_id uuid NOT NULL REFERENCES mat_silver.competition(tournament_calendar_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.series (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    stage_id uuid NOT NULL REFERENCES mat_silver.stage(id) ON DELETE CASCADE ON UPDATE CASCADE,
    name varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS mat_silver.team (
    ...
    code varchar(3) NOT NULL DEFAULT '',
    country_id uuid DEFAULT NULL REFERENCES mat_silver.country(id) ON DELETE SET NULL ON UPDATE CASCADE
    /*
...
CREATE TABLE IF NOT EXISTS mat_silver.contestant (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    team_id uuid NOT NULL REFERENCES mat_silver.team(id) ON DELETE CASCADE ON UPDATE CASCADE,
    competition_id uuid NOT NULL REFERENCES mat_silver.competition(id) ON DELETE CASCADE ON UPDATE CASCADE,
    tournament_calendar_id uuid NOT NULL REFERENCES mat_silver.competition(tournament_calendar_id) ON DELETE CASCADE ON UPDATE CASCADE
    /*
...
DROP TABLE IF EXISTS mat_silver.match;
CREATE TABLE IF NOT EXISTS mat_silver.match (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    description text NOT NULL DEFAULT '',
    local_date date NOT NULL,
    local_time timestamptz NOT NULL,
    last_updated timestamptz NOT NULL,
    competition_id uuid REFERENCES mat_silver.competition(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    tournament_calendar_id uuid REFERENCES mat_silver.competition(tournament_calendar_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    stage_id uuid REFERENCES mat_silver.stage(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    series_id uuid REFERENCES mat_silver.series(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    home_team_id uuid REFERENCES mat_silver.contestant(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    away_team_id uuid REFERENCES mat_silver.contestant(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.player (
    ...
    club_id uuid REFERENCES mat_silver.team(id) ON DELETE SET NULL ON UPDATE CASCADE,
    national_team_id uuid REFERENCES mat_silver.team(id) ON DELETE SET NULL ON UPDATE CASCADE,
    nationality_id uuid REFERENCES mat_silver.country(id) ON DELETE SET NULL ON UPDATE CASCADE,
    main_position varchar(15) DEFAULT ''
    /*
...
CREATE TABLE IF NOT EXISTS mat_silver.lineup (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    team_id uuid REFERENCES mat_silver.team(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    match_id uuid REFERENCES mat_silver.match(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    player_id uuid REFERENCES mat_silver.player(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.match_event (
    ...
    team_id uuid REFERENCES mat_silver.team(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    player_id uuid REFERENCES mat_silver.lineup(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.event_qualifier (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    event_id uuid REFERENCES mat_silver.match_event(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.match_details (
    match_id uuid PRIMARY KEY REFERENCES mat_silver.match_event(id) ON DELETE CASCADE ON UPDATE CASCADE,
    match_played boolean NOT NULL DEFAULT FALSE,
    match_status varchar(10) NOT NULL DEFAULT '',
    match_winner uuid REFERENCES mat_silver.contestant(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.passmap (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    match_id uuid NOT NULL REFERENCES mat_silver.match_event(id) ON DELETE CASCADE ON UPDATE CASCADE,
    passer_id uuid NOT NULL REFERENCES mat_silver.lineup(id) ON DELETE CASCADE ON UPDATE CASCADE,
    receiver_id uuid NOT NULL REFERENCES mat_silver.lineup(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.team_stats (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    match_id uuid NOT NULL REFERENCES mat_silver.match_event(id) ON DELETE CASCADE ON UPDATE CASCADE,
    contestant_id uuid NOT NULL REFERENCES mat_silver.contestant(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS mat_silver.player_stats (
    id uuid PRIMARY KEY DEFAULT uuidv7(),
    match_id uuid NOT NULL REFERENCES mat_silver.match_event(id) ON DELETE CASCADE ON UPDATE CASCADE,
    player_id uuid NOT NULL REFERENCES mat_silver.lineup(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP MATERIALIZED VIEW IF EXISTS mat_gold.percentile;
CREATE MATERIALIZED VIEW IF NOT EXISTS mat_gold.percentile (
